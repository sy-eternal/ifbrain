...
@Controller
@RequestMapping("/questionoptionimage")
public class QuestionOptionImageController
{
    
    @Autowired
    private QuestionOptionImageRepository  _questionOptionImageRepository;
    @Autowired
    ...
    {
    	QuestionOptionImage image = _questionOptionImageRepository.findOne(id);
