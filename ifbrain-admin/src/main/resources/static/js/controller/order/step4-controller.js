var Step4Controller = function() {
	...
	var showMarginPlanPlan = function() {
		var url =  Web.contextPath + "/marginplan/search?orderId=" +  _orderId;
		$.get(url, function(marginPlans) {
			console.log(marginPlans);
			_dataTableMarginPlan = $("#marginPlan").DataTable({
				language : {
					url : Web.contextPath + "/js/lib/datatables/Chinese.json"
				},
				paging : false,
