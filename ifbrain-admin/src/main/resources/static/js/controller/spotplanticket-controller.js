var SpotPlanTicketController = function () {
	var table =  $("#table"); 
				          ...
				          columnDefs: [
{
	render : function(data, type, row) {
		var id = row.id;
		var link="";
		link="<input  type='radio' name='check'  id='check"+id+"' disabled='disabled' onclick='javascript: SpotPlanTicketController.changecheck("+id+")''/>"+
...
,{
	render : function(data, type, row) {
		var id = row.id;
		var link="";
		link="<input type='number' min='0' name='personCount'  id='personCount"+id+"' value='0'  onchange='javascript: SpotPlanTicketController.changepersonCount("+id+")'/>" ;
		return link;
	},
	targets : 3
