var planedInfoController = function () {
    var _orderId = null;
        ...
        $.get(url, function (datePlans) {
            _dataTableVehiclePlan = $("#tableVehiclePlan").DataTable({
                ...
                columns: [{
                    ...
                    data: "vehiclePlan.supplierOrderNumber"
                }, {
                ...
                columnDefs: [{
                    ...
                    render: function (data, type, row) {
                        var vehiclePlanId = row.vehiclePlan.id;
                        var datePlanId = row.id;
                        var link = "<a href='" + Web.contextPath + "/datePlan/updateVehicle/" + vehiclePlanId + "'>编辑</a>";

                        //var link = "<a href='javascript:VisitorCenterController.deleteOrder(" + vehiclePlanId + ")'>编辑</a>";
                        return link;
                    },
                    targets: 16
                }
        ...
        $.get(url, function (spotPlans) {
            _dataTableSpotPlan = $("#tableSpotPlan").DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function (data, type, row) {
                        var spotPlanId = row.id;
                        var link = "<a href='" + Web.contextPath + "/spotPlan/updateSpotPlan/" + spotPlanId + "'>编辑</a>";
        ...
        $.get(url, function (hotelPlans) {
            _dataTableHotelPlan = $("#tableHotelPlan").DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function (data, type, row) {
                        var hotelPlanId = row.id;
                        var link = "<a href='" + Web.contextPath + "/hotelPlan/updateHotelPlan/" + hotelPlanId + "'>编辑</a>";
