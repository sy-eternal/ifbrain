...
var routecarplan = function () {
var oTable;

           var showTable = function () {
        	var url ="/routeplancar/search";
    		$.get(url,function(routecarplan) {
    	  console.log(JSOG.decode(routecarplan));
         ...
         columnDefs: [
{
				                        ...
				                        ,{
				                        	render : function(data, type, row) {
				                        		var id = row.id;
				                        		var link="";
				                        		link="<input type='number' min='0' name='personCount'  id='personCount"+id+"' value='0'  onchange='javascript: routecarplan.changepersonCount("+id+")'/>" ;
				                        		return link;
				                        	},
				                        	targets : 4
				                        ...
				                        render : function(data, type, row) {
			                        		var id = row.id;
			                        		var link="";
			                        		link="<input  type='checkbox' name='check'  id='check"+id+"' disabled='disabled' onclick='javascript: routecarplan.changecheck("+id+")''/>"+
