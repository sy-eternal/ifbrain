 ...
 */
@Entity
@Table(name ="t_guide_order_guide_relate")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
@JsonIdentityInfo(generator = JSOGGenerator.class)
public class GuideOrderGuideRelate {
	 ...
	 * 导游订单主键
	 */
	@ManyToOne (targetEntity=GuideOrder.class)
	@JoinColumn(name="guide_order_id", updatable =true)
