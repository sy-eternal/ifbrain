...
@Entity
@Table(name = "t_route_spot_plan_ticket")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
@JsonIdentityInfo(generator = JSOGGenerator.class)
public class RouteSpotPlanTicket
{
    @Id
    ...
    private RouteSpotPlan routeSpotPlan;
     ...
     */
     ...
     public RouteSpotPlan getRouteSpotPlan() {
 		return routeSpotPlan;
 	}


 	public void setRouteSpotPlan(RouteSpotPlan routeSpotPlan) {
 		this.routeSpotPlan = routeSpotPlan;
 	}
