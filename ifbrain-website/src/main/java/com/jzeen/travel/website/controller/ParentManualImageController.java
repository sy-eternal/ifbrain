...
@Controller
@RequestMapping("/parentmanualimage")
public class ParentManualImageController
{
    @Autowired
    private ParentManualImageRepository  _ParentManualImageRepository;
    ...
    {
    	ParentManualImage image = _ParentManualImageRepository.findOne(id);
