...
import com.jzeen.travel.wechat.message.model.BaiduPlace;
...
public class BaiduMapUtil {
	...
	public static List<BaiduPlace> searchPlace(String query, String lng,
		...
		// 拼装请求地址
		String requestUrl = "http://api.map.baidu.com/place/v2/search?&query=QUERY&location=LAT,LNG&radius=2000&output=xml&scope=2&page_size=10&page_num=0&ak=81218080E79C9685b35e757566d8cbe5";
