    ...
    return {
        ...
        initMiniCharts: function () {
            ...
            $('.easy-pie-chart .number.transactions').easyPieChart({
                ...
                size: 60,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('grey')
            });
            ...
            $('.easy-pie-chart1 .number.transactions').easyPieChart({
                animate: 1000,
                size: 60,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('grey')
            ...
            $('.easy-pie-chart1 .number.visits').easyPieChart({
                animate: 1000,
                size: 60,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('green')
            ...
            $('.easy-pie-chart1 .number.bounce').easyPieChart({
                animate: 1000,
                size: 60,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('red')
            ...
            $('.easy-pie-chart-reload').click(function () {
                $('.easy-pie-chart1 .number').each(function () {
