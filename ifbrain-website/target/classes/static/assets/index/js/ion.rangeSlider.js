...
;(function ($, document, window, navigator, undefined) {
    ...
    var double_html =
        ...
        '<span class="irs-slider from" onclick="ga(\'send\', \'event\', \'link\', \'click\', \'CourseStructure_LVP_Now\');"></span>' +
        '<span class="irs-slider to" onclick="ga(\'send\', \'event\', \'link\', \'click\', \'CourseStructure_LVP_Target\');"></span>';
        ...
        drawLabels: function () {
            ...
            if (this.options.type === "single") {
                ...
                if (values_num) {
                    ...
                    this.$cache.from.html(rangeSlider1);//text_from
                    this.$cache.to.html(rangeSlider2);//text_to
