...
+function(){
	...
	PureClearButton.prototype.create = function(){
		...
		// Clear Button鞚� input element 霋る 靸濎劚頃滊嫟.
	...
	$.extend($.pureClearButton, {
		DEFAULTS: {
			// jquery-validation鞚� 靷毄頃橃榾鞚� 瓴届毎 clear鞚错泟 valid 鞝曤炒 鞝滉卑 鞐秬
			clearValidation: true,			
			// Clear Button鞚� icon with bootstrap
	...
	$(window).on('load', function(){
		// ".has-text-clear" Class毳� 歆€鞝曧暅 Input Text鞐� 雮挫毄 靷牅 氩勴娂鞚� 於旉皜頃滊嫟.
